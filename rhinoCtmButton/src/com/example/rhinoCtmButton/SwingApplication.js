...
swingNames.importPackage(Packages.com.example.rhinoCtmButton);
...
function createComponents()
{
    with (swingNames) {
        ...
        /** ctm button from packages.ctm.widgets */
        var cBtn = new ctmButton("I'm a ctm button!");
        ...
        cBtn.addActionListener(function() {
                 numClicks += 1;
                 label.setText(labelPrefix + numClicks);
             });
...
with (swingNames) {
    ...
    // warning: this function(event,methodName) has different signature of a WindowListener
    // todo: make it clear
/*
